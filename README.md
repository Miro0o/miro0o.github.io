...
- `assets/data/` contains the JavaScript data snapshots used by the pages.
- `assets/images/` and `assets/media/` contain static visual and media resources.

Local generators, private source metadata, maintenance notes, photo-management tools, caches, and build artefacts are intentionally excluded from the public repository.
